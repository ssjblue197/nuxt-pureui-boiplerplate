...
module.exports = {
  ...
  theme: {
    ...
    animation: {
      ...
      fly: 'fly 2.5s infinite',
      suspended: 'suspended 10s infinite',
      opacity: 'opacity 10s infinite',
  ...
  plugins: [
    ...
    plugin(function ({ addVariant, e }) {
      addVariant('access', ':is(:where(.access) &)');
    }),
  ],
};
